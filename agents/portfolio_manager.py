...
""",
    ...
    MarketType.CRYPTO: {
        "name": "加密货币技术与链上策略",
        "description": "重技术面走势、链上情绪和资金费率，基本面权重极低",
        "weights": {
            "fundamental": 0.05,   # 极低：Crypto无传统PE/PB估值体系
            "sentiment": 0.35,     # 高：链上情绪/资金费率/社交媒体情绪驱动大
            "technical": 0.50,     # 最高：技术形态/支撑阻力/趋势是核心判断
            "risk": 0.10,
        },
        "decision_focus": [
            "技术形态：趋势方向、关键支撑/阻力、量价配合",
            "链上活跃度：活跃地址/交易量是否支撑价格",
            "资金费率：永续合约资金费率是否过热或过冷",
            "市场主导地位：BTC/ETH主导权变化",
            "宏观流动性：美债收益率/美元指数对Crypto的影响",
        ],
        "decision_cautions": [
            "加密货币波动性极高，仓位管理至关重要",
            "警惕资金费率过高时的多头挤仓风险",
...
【Crypto特殊决策原则】
当前采用加密货币技术与链上策略：
1. 技术权重 50%：趋势方向、关键支撑阻力位、量价配合是核心判断标准
2. 情绪权重 35%：资金费率、链上活跃度、社交媒体情绪是重要信号
3. 基本面权重仅 5%：链上数据作为辅助参考，无传统估值意义
4. 加密货币24小时交易，情绪驱动强，技术信号的有效性相对更高
5. 必须更严格执行止损纪律（波动性是股票的3-5倍）
""",
    },
}
